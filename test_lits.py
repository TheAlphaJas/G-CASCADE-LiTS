...
from utils.dataset_lits import LITSTestDataset
from utils.utils import test_single_volume, random_split_array
...
def inference_lits(args, model, db_test, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        metric_i = test_single_volume(image, label, model, classes=args.num_classes, patch_size=[args.img_size, args.img_size],
                                      test_save_path=test_save_path, case=case_name, z_spacing=1, class_names=args.num_classes)
